...
public class UserDetailScreen extends BaseMultipleFragment implements GeneralDialog.DecisionListener {
    ...
    private TextView fragment_user_detail_tv_id, fragment_user_detail_tv_name, fragment_user_detail_tv_dob, fragment_user_detail_tv_career, fragment_user_detail_tv_gender, fragment_user_detail_tv_phone;
    ...
    public void onBindView() {
        ...
        findViewById(R.id.fragment_user_detail_rl_manage_device);
    ...
    public void onSingleClick(View v) {
        switch (v.getId()) {
            case R.id.fragment_user_detail_rl_manage_device:
