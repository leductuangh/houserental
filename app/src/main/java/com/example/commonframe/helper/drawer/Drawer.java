package com.example.commonframe.helper.drawer;
...
public class Drawer extends FrameLayout {
    ...
    public Drawer(Activity act, Interpolator ip, int duration) {
     ...
     * </p>
     *
     * @param leftBehindLayout: The layout id, under the res/layout
    ...
    public View setLeftBehindContentView(int leftBehindLayout) {
        final View content = ((LayoutInflater) getContext().getSystemService(
                ...
                mLeftBehindBase);
        mLeftPaddingRect = new Rect(content.getPaddingLeft(),
     ...
     * </p>
     *
     * @param rightBehindLayout: The layout id, under the res/layout
     *                           directory, which is displayed left side. </p>
     * @return The view which will be created from the layout id.
     */
    public View setRightBehindContentView(int rightBehindLayout) {
        final View content = ((LayoutInflater) getContext().getSystemService(
                ...
                mRightBehindBase);
        mRightPaddingRect = new Rect(content.getPaddingLeft(),
                content.getPaddingTop(), content.getPaddingRight(),
                content.getPaddingBottom());
