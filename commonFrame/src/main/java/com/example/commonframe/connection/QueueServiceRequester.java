...
public class QueueServiceRequester implements Listener<QueueResponse>,
	...
	public interface QueueServiceListener {
		 ...
		 *
		 * @param remain
		 *            The elements remaining in the queue include the stopped
		 *            element
		 */
		 ...
		 *
		 * @param target
		 *            The target request had been called on
		 * @param error
	...
	private enum Notify {
		START, FINISH, BLOCK, STOP, RESULT_SUCCESS, RESULT_FAIL, FAIL
	}
