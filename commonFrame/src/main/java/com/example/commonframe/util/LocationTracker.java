...
public class LocationTracker {
	...
	public interface LocationUpdateListener {
		 ...
		 * 
		 * @param location
		 *            The location has been retrieved from either GPS or
		 *            NETWORK.
		 * @param type
		 *            The pre-defined scanning method, can be specified by user
		 ...
		 * 
		 * @param error
		 *            The string to indicate the error of location detection.
		 */
		 ...
		 * 
		 * @param time_out
		 *            The total seconds of the detection process. The value of 0
		 *            means no time-out.
		 * @param countdown
		 *            The seconds has left in detecting location.S
		 */
	...
	/**
	 * @param timeStep
	 *            the timeStep to set, minimum value is 1, any negative values
	...
	/**
	 * @param timeOut
	 *            the timeOut to set, minimum is 0 and means no time-out, any
	...
	/**
	 * @param gPSAllowed
	 *            the gPSAllowed to set, indicating whether the detection can
	 *            perform by GPS, true means allow, otherwise false
	 */
	...
	/**
	 * @param networkAllowed
	 *            the networkAllowed to set, indicating whether the detection
	...
	/**
	 * @param lastKnowLocationAllowed
	 *            the lastKnowLocationAllowed to set, indicating whether the
	...
	/**
	 * @param trackingModeAllowed
	 *            the trackingModeAllowed to set, indicating whether the
	...
	/**
	 * @param prioritizedMethod
	 *            the prioritizedMethod to set, only GPS and Network method will
	...
	/**
	 * @param listener
	 *            the listener to set to handle location detection success, fail
	 *            or process
	 */
	...
	public boolean isTracking() {
		if (location_update != null)
			return location_update.isTracking();
		return false;
	}
	...
	private class LocationUpdate implements Runnable {
		 ...
		 * 
		 * @param location
		 *            The changed location to update
		 */
