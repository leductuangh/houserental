...
public interface BaseInterface {
	 ...
	 */
	void makeRequest(String tag, RequestTarget target, BaseParam content,
	 ...
	 * Every target must be defined in enum BackgroundRequestTarget in Constant
	 * and override the <code>toString()</code> to return the actual function of
	 * the web-service. <br>
	 * Every request content must be derived from BaseParam and implements
	 * <code>makeRequestParams()</code> for the parameters and
	 * <code>makeRequestHeaders()</code> for the headers of the web-service.
	 ...
	 *            The content of the request including parameters and headers
	 */
	void makeBackgroundRequest(String tag, BackgroundRequestTarget target,
			BaseParam content);
